...
export const DATA_VERSION = '4.3';

export const INITIAL_TITLE_ALLOCATION = [
  { id: 'rebar-shop', title: 'Арматурный цех тит 50 и площадка ОГ', itr: 0, workers: 7, workType: 'Загатовка: ОГ, арматурных изделий, уборка по всей площадке', subcontractor: 'INTEGRA' },
  { id: '0.0-blitz', title: 'Титул 0.0 (КЖ1)', itr: 1, workers: 26, workType: 'Устройство армирования', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: 'doosan', title: 'Склад Doosan', itr: 0, workers: 6, workType: 'Вывоз материалов со склада на строй площадку', subcontractor: 'INTEGRA' },
  { id: '1.1-stroy', title: 'Титул 1.1 (Stroy Consulting-2050)', itr: 1, workers: 4, workType: 'Монтаж М/К', subcontractor: 'Stroy Consulting-2050' },
  { id: '1.1-sst', title: 'Титул 1.1 (SST Building)', itr: 1, workers: 17, workType: 'Монтаж оборудования', subcontractor: 'SST Building' },
  { id: '1.1-kj45-blitz', title: 'Титул 1.1 Кж4.5', itr: 1, workers: 10, workType: 'Устройство армокаркаса, устранение замечаний, монтаж опалубки', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '1.1-blitz', title: 'Титул 1.1 (КЖ 2, 6, 7, 8, 16)', itr: 1, workers: 30, workType: 'Устройство армокаркаса, чипинг колонн', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '1.1-baibol', title: 'Титул 1.1 (КЖ15) ТОО Baibol', itr: 1, workers: 11, workType: 'Устройство армирования', subcontractor: 'ТОО Baibol' },
  { id: '1.2-ancon', title: 'Титул 1.2 (ТОО Ancon)', itr: 1, workers: 76, workType: 'Устройство армирования', subcontractor: 'ТОО Ancon' },
  ...
  { id: '1.3-blitz', title: 'Титул 1.3 (ТОО Блиц-Монтаж)', itr: 1, workers: 40, workType: 'Устройство армирования', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '3-blitz', title: 'Титул 3 (ТОО Блиц-Монтаж)', itr: 1, workers: 10, workType: 'Устройство армирования', subcontractor: 'ТОО Блиц-Монтаж' },
  ...
  { id: '8.1', title: 'Титул 8.1 (TOWER CONSTRUCTION 2030)', itr: 2, workers: 1, workType: 'Инженерные сети / Installation of sandwich panels', subcontractor: 'TOWER CONSTRUCTION 2030' },
  { id: '8.2', title: 'Титул 8.2 (ТОО NUR-AKHMED GROUP)', itr: 1, workers: 2, workType: 'Инженерные сети / Installation of sandwich panels', subcontractor: 'ТОО NUR-AKHMED GROUP' },
  ...
  { id: '10.11', title: 'Титул 10.11 (ТОО Блиц-Монтаж)', itr: 1, workers: 13, workType: 'Монтаж опалубки', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '12.1', title: 'Титул 12.1 (TOWER CONSTRUCTION 2030)', itr: 1, workers: 2, workType: 'Подготовительные работы к монтажу ФБц панелей', subcontractor: 'TOWER CONSTRUCTION 2030' },
  ...
  { id: '24', title: 'Титул 24 (ТОО QPARK group)', itr: 1, workers: 14, workType: 'Устройство армокаркаса', subcontractor: 'ТОО QPARK group' },
  { id: '25-atameken', title: 'Титул 25 (ТОО АТАМЕКЕН-ҚС)', itr: 1, workers: 10, workType: 'Устройство армокаркаса, демонаж и монтаж опалубки, монтаж лесов', subcontractor: 'АТАМЕКЕН-ҚС' },
  { id: '25-sst', title: 'Титул 25 (SST Building)', itr: 0, workers: 3, workType: 'Монтаж перегородочного газоблока', subcontractor: 'SST Building' },
  { id: '25-mega', title: 'Титул 25 (Мега Мост)', itr: 1, workers: 5, workType: 'Устройство армокаркаса', subcontractor: 'Мега Мост' },
  { id: '25-blitz', title: 'Титул 25 (Блиц-Монтаж)', itr: 1, workers: 5, workType: 'Устройство армокаркаса', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '27-blitz', title: 'Титул 27 (Блиц-Монтаж)', itr: 0, workers: 5, workType: 'Устройство армокаркаса', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '32', title: 'Титул 32 (TOO Q17 CONSTRUCTION)', itr: 1, workers: 3, workType: 'Монтаж М/К', subcontractor: 'TOO Q17 CONSTRUCTION' },
  { id: '34', title: 'Титул 34 (Блиц-Монтаж)', itr: 1, workers: 5, workType: 'Устройство армокаркаса', subcontractor: 'Блиц-Монтаж' },
  { id: '38', title: 'Титул 38 (ТОО Адал Жарық Құрылыс)', itr: 1, workers: 18, workType: 'Устройство армокаркаса', subcontractor: 'ТОО Адал Жарық Құрылыс' },
  ...
  { id: '43', title: 'Титул 43 (ТОО Блиц-Монтаж)', itr: 1, workers: 45, workType: 'Устройство армокаркаса, демонаж и монтаж опалубки, монтаж лесов', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '44', title: 'Титул 44 (ТОО Блиц-Монтаж)', itr: 1, workers: 80, workType: 'Устройство армокаркаса, демонаж и монтаж опалубки, монтаж лесов', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '48', title: 'Титул 48 ТОО "NUR-AKHMED GROUP"', itr: 0, workers: 2, workType: 'Монтаж Сэндвич панелей', subcontractor: 'ТОО NUR-AKHMED GROUP' },
  { id: '46', title: 'Титул 46 (ТОО Блиц-Монтаж)', itr: 0, workers: 5, workType: 'Устройство армокаркаса, демонаж и монтаж опалубки, монтаж лесов', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '50-kz3', title: 'Титул 50 (КЖ3) (ТОО Мейрам Құрылыс)', itr: 1, workers: 2, workType: 'Монтаж м/к', subcontractor: 'ТОО Мейрам Құрылыс' },
  { id: '50-kz4-kz7', title: 'Титул 50 (КЖ4, КЖ7) (ТОО Блиц-Монтаж)', itr: 0, workers: 2, workType: 'Устройство армокаркаса, демонаж и монтаж опалубки', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '50-kz4-atameken', title: 'Титул 50 (КЖ4) (ТОО АТАМЕКЕН-ҚС)', itr: 1, workers: 4, workType: 'Устройство армокаркаса, демонаж и монтаж опалубки', subcontractor: 'АТАМЕКЕН-ҚС' },
  { id: '50-kz4-blitz', title: 'Титул 50 (КЖ4) (ТОО Блиц-Монтаж)', itr: 0, workers: 5, workType: 'Устройство армокаркаса, демонаж и монтаж опалубки', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '50-kz5-big-bastau', title: 'Титул 50 (КЖ5) (ТОО BIG BASTAU)', itr: 1, workers: 2, workType: 'Монтаж м/к', subcontractor: 'BIG BASTAU' },
  { id: '50-kz5-blitz', title: 'Титул 50 (КЖ5) (ТОО Блиц-Монтаж)', itr: 0, workers: 3, workType: 'Устройство армокаркаса, демонаж и монтаж опалубки', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: '50-kz7-8', title: 'Титул 50 (КЖ7-8) (ТОО Блиц-Монтаж)', itr: 0, workers: 3, workType: 'Устройство армокаркаса, демонаж и монтаж опалубки', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: 'forestry', title: 'Лесомонтажники (ТОО Блиц-Монтаж)', itr: 2, workers: 59, workType: 'Монтаж строительных лесов', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: 'pipeshop', title: 'Трубный цех (ТОО Блиц-Монтаж)', itr: 1, workers: 22, workType: 'Сборка трубного цеха', subcontractor: 'ТОО Блиц-Монтаж' },
  { id: 'imstalkon', title: 'АО Имсталькон (Титул 1.1)', itr: 1, workers: 18, workType: 'Монтаж м/к', subcontractor: 'АО Имсталькон' },
  { id: 'stecol-1.1', title: 'ТОО STECOL (Титул 1.1)', itr: 2, workers: 13, workType: 'Монтаж оборудования', subcontractor: 'ТОО STECOL' },
  { id: 'stecol-2.1', title: 'ТОО STECOL (Титул 2.1)', itr: 7, workers: 16, workType: 'Монтаж м/к', subcontractor: 'ТОО STECOL' },
  { id: 'stecol-2.2', title: 'ТОО STECOL (Титул 2.2)', itr: 0, workers: 3, workType: 'Монтаж м/к', subcontractor: 'ТОО STECOL' },
  { id: 'stecol-9', title: 'ТОО STECOL (Титул 9)', itr: 0, workers: 4, workType: 'Монтаж м/к', subcontractor: 'ТОО STECOL' },
  ...
  { id: 'aup-subs', title: 'АУП субподрядных организаций', itr: 12, workers: 0, workType: 'Административно-управленческий персонал', subcontractor: 'Субподрядчики' },
  { id: 'mech-integra', title: 'Механизаторы (ПГУ)', itr: 0, workers: 74, workType: 'Машинисты и водители', subcontractor: 'INTEGRA' },
];
...
export const INITIAL_HR: HumanResource[] = [
  { "subcontractor": "ИТОГО", "total": 1107, "itr": 167, "workers": 940, "lastUpdate": "12.03.2026" },
  { "subcontractor": "ТОО INTEGRA CONSTRUCTION KZ", "total": 152, "itr": 115, "workers": 37, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Арматурный цех тит 50 и площадка ОГ", "total": 7, "itr": 0, "workers": 7, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 0.0 (КЖ1) ТОО Блиц-Монтаж", "total": 43, "itr": 1, "workers": 42, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Склад Doosan", "total": 9, "itr": 0, "workers": 9, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 1.1 (Stroy Consulting 2050)", "total": 6, "itr": 1, "workers": 5, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 1.1 (SST Building)", "total": 6, "itr": 1, "workers": 5, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 1.1 Кж4.5 (Блиц-Монтаж)", "total": 9, "itr": 1, "workers": 8, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 1.1 (КЖ 2, 6, 7, 8, 16) Блиц-Монтаж", "total": 40, "itr": 1, "workers": 39, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 1.1 (КЖ15) ТОО Baibol", "total": 20, "itr": 1, "workers": 19, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 1.2 (ТОО Ancon)", "total": 81, "itr": 1, "workers": 80, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 1.2 (ТОО Блиц-Монтаж)", "total": 41, "itr": 1, "workers": 40, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 1.3 (ТОО Блиц-Монтаж)", "total": 44, "itr": 1, "workers": 43, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 3 (ТОО Блиц-Монтаж)", "total": 8, "itr": 1, "workers": 7, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 5.2 - 5.4 (ТОО Блиц-Монтаж)", "total": 17, "itr": 1, "workers": 16, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 6.1 (ТОО Блиц-Монтаж)", "total": 5, "itr": 0, "workers": 5, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 8.1 (Квант)", "total": 3, "itr": 2, "workers": 1, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 8.2 (ТОО NUR-AKHMED GROUP)", "total": 3, "itr": 1, "workers": 2, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 9 (0.0 Кж1) (ТОО Блиц-Монтаж)", "total": 6, "itr": 0, "workers": 6, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 10.11 (ТОО Блиц-Монтаж)", "total": 14, "itr": 1, "workers": 13, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 12.1 (Квант)", "total": 4, "itr": 1, "workers": 3, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 13.4 (Stroy Consulting-2050)", "total": 6, "itr": 1, "workers": 5, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 15.1 (ТОО QPARK group)", "total": 5, "itr": 1, "workers": 4, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 15.2-15.3 (KBP)", "total": 2, "itr": 0, "workers": 2, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 16 (ТОО Блиц-Монтаж)", "total": 28, "itr": 1, "workers": 27, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 24 (ТОО QPARK group)", "total": 15, "itr": 1, "workers": 14, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 25 (ТОО АТАМЕКЕН-ҚС)", "total": 19, "itr": 1, "workers": 18, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 25 (SST Building)", "total": 6, "itr": 1, "workers": 5, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 25 (Мега Мост)", "total": 8, "itr": 1, "workers": 7, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 25 (Блиц-Монтаж)", "total": 9, "itr": 1, "workers": 8, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 27 (Блиц-Монтаж)", "total": 5, "itr": 0, "workers": 5, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 32 (ТОО Q17 CONSTRUCTION)", "total": 6, "itr": 1, "workers": 5, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 34 (Блиц-Монтаж)", "total": 6, "itr": 1, "workers": 5, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 38 (ТОО Адал Жарық Құрылыс)", "total": 14, "itr": 1, "workers": 13, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 39 (ТОО Блиц-Монтаж)", "total": 4, "itr": 0, "workers": 4, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 42 (ТОО Ancon)", "total": 21, "itr": 2, "workers": 19, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 43 (ТОО Блиц-Монтаж)", "total": 50, "itr": 1, "workers": 49, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 44 (ТОО Блиц-Монтаж)", "total": 66, "itr": 1, "workers": 65, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 48 ТОО \"NUR-AKHMED GROUP\"", "total": 3, "itr": 1, "workers": 2, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 47.1 (ТОО Блиц-Монтаж)", "total": 6, "itr": 0, "workers": 6, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 50 (КЖ3) (ТОО Мейрам Құрылыс)", "total": 3, "itr": 1, "workers": 2, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 50 (КЖ4, КЖ7) (ТОО Блиц-Монтаж)", "total": 3, "itr": 0, "workers": 3, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 50 (КЖ4) (ТОО АТАМЕКЕН-ҚС)", "total": 5, "itr": 1, "workers": 4, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 50 (КЖ4) (ТОО Блиц-Монтаж)", "total": 6, "itr": 0, "workers": 6, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 50 (КЖ5) (ТОО Блиц-Монтаж)", "total": 4, "itr": 0, "workers": 4, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Титул 50 (КЖ7-8) (ТОО Блиц-Монтаж)", "total": 5, "itr": 0, "workers": 5, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Лесомонтажники (ТОО Блиц-Монтаж)", "total": 61, "itr": 2, "workers": 59, "lastUpdate": "12.03.2026" },
  { "subcontractor": "Трубный цех (ТОО Блиц-Монтаж)", "total": 18, "itr": 1, "workers": 17, "lastUpdate": "12.03.2026" },
  { "subcontractor": "АО Имсталькон", "total": 23, "itr": 1, "workers": 22, "lastUpdate": "12.03.2026" },
  { "subcontractor": "TOO STECOL", "total": 54, "itr": 3, "workers": 51, "lastUpdate": "12.03.2026" },
  { "subcontractor": "KZ\"Construction Go\"", "total": 7, "itr": 1, "workers": 6, "lastUpdate": "12.03.2026" }
];

export const INITIAL_EQUIPMENT: Equipment[] = [
  { id: '1', type: 'Пикап', model: '—', plateNumber: '—', operator: '—', phone: '—', category: EquipmentCategory.TRANSPORT, ownerType: 'GEN', ownerName: 'ТОО Integra', status: 'ACTIVE', total: 3, genPodryad: 3, subPodryad: 0 },
  { id: '2', type: 'Экскаватор', model: '—', plateNumber: '—', operator: '—', phone: '—', category: EquipmentCategory.EARTHMOVING, ownerType: 'GEN', ownerName: 'ТОО Integra', status: 'ACTIVE', total: 21, genPodryad: 21, subPodryad: 0 },
  { id: '3', type: 'Кран', model: '—', plateNumber: '—', operator: '—', phone: '—', category: EquipmentCategory.LIFTING, ownerType: 'GEN', ownerName: 'ТОО Integra', status: 'ACTIVE', total: 27, genPodryad: 27, subPodryad: 0 },
  { id: '4', type: 'Каток', model: '—', plateNumber: '—', operator: '—', phone: '—', category: EquipmentCategory.ROAD, ownerType: 'GEN', ownerName: 'ТОО Integra', status: 'ACTIVE', total: 13, genPodryad: 13, subPodryad: 0 },
  { id: '5', type: 'Самосвал', model: '—', plateNumber: '—', operator: '—', phone: '—', category: EquipmentCategory.TRUCKS, ownerType: 'GEN', ownerName: 'ТОО Integra', status: 'ACTIVE', total: 10, genPodryad: 10, subPodryad: 0 },
  { id: '6', type: 'Фронтальный - Погрузчик', model: '—', plateNumber: '—', operator: '—', phone: '—', category: EquipmentCategory.EARTHMOVING, ownerType: 'GEN', ownerName: 'ТОО Integra', status: 'ACTIVE', total: 7, genPodryad: 7, subPodryad: 0 },
  ...
  { id: '9', type: 'Длинномер', model: '—', plateNumber: '—', operator: '—', phone: '—', category: EquipmentCategory.TRUCKS, ownerType: 'GEN', ownerName: 'ТОО Integra', status: 'ACTIVE', total: 3, genPodryad: 3, subPodryad: 0 },
  { id: '10', type: 'Водовоз', model: '—', plateNumber: '—', operator: '—', phone: '—', category: EquipmentCategory.TRUCKS, ownerType: 'GEN', ownerName: 'ТОО Integra', status: 'ACTIVE', total: 1, genPodryad: 1, subPodryad: 0 },
  ...
  { id: '21', type: 'Манипулятор', model: '—', plateNumber: '—', operator: '—', phone: '—', category: EquipmentCategory.LIFTING, ownerType: 'SUB', ownerName: 'TOO Ancon', status: 'ACTIVE', total: 1, genPodryad: 0, subPodryad: 1 },
